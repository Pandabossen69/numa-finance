...
/**
 * Canonical NUMA shell — mobile bottom nav + desktop sidenav.
 * One composition; no emergency/hotfix chrome.
 */
    ...
    <div className="mx-auto min-h-dvh w-full max-w-[var(--numa-shell-max)] px-4 md:px-8">
      <div className="flex gap-8 md:gap-12">
        ...
        <div className="min-w-0 flex-1">
          <header
            className="flex items-center justify-between pt-[max(1rem,var(--numa-safe-top))] pb-2 md:hidden"
          >
            <a href="/idag" className="block">
