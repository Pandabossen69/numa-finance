...
export function MerBackLink({
  ...
  return (
    <Link
      href={href}
      prefetch
      className="inline-flex items-center gap-1.5 text-[13px] font-medium text-[var(--numa-muted)] transition hover:text-[var(--numa-ink)]"
    >
...
export function MerListLink({
  ...
  return (
    <Link
      href={href}
      prefetch
      className="group flex min-h-[3.25rem] items-center gap-3 border-b border-[var(--numa-border)] px-4 py-3.5 last:border-b-0 transition active:bg-[var(--numa-accent-soft)]/35 hover:bg-white/55"
    >
